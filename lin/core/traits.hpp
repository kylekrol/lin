 ...
 *
 *  1. Provide a mechanism for the leaves of the lin inheritance tree
 *     communicate their compile time traits to their parents classes.
 ...
 *  They can, for example, detect at compile time whether or not a given
 *  operation "makes sense" with two arbitrary tensor types.
 *
 ...
 *  ~~~
 *
 *  This can be extended to matrix factorizations and more complex operations.
 *  See the list of structs above for more ideas!
 */
